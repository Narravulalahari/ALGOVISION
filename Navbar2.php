...
<body>
  <nav class="navbar">
    <a href="#" class="navbar-brand"><img src="images/logoo.png" height="60px" width="60px">&nbsp;&nbsp;&nbsp;<div class="titlee">A L G O V I S I O N</div></a>
    ...
    <ul class="navbar-menu" id="navbar-menu">
      ...
      <li> <a href="visualise.php">Visualize</a></li>
      <li><a href="practice.php">Practice</a></li>
      <li><a href="about.php">About</a></li>
      <li style="border:1px solid white;"><a href="login/login.php">Login</a></li>
    </ul>
  </nav>
